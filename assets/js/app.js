...
var _crewData = _interopRequireDefault(require("./modules/crew-data"));

var _postcards = _interopRequireDefault(require("./modules/postcards"));
...
var map = function () {
  ...
  var frame = document.querySelector('.map iframe');
...
var postcards = function () {
  var postcard = document.querySelectorAll('.postcard');

  var postcardsInit = function postcardsInit() {
    postcard.forEach(function (element) {
      element.addEventListener('click', function () {
...
var swiperSlider = function () {
  var swiperInit = function swiperInit() {
    var swiperPostcards = new Swiper('.postcards-slider', {
      slidesPerView: 1,
      spaceBetween: 30,
      initialSlide: 1,
      speed: 500,
