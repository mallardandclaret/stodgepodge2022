    ...
    <main class="main">
        ...
        <div class="departure-board">
          ...
          <div class="board-data">
            ...
            <div class="row first">
              ...
              <span class="letter letter-blank"></span>
              <span class="letter green letter-2"></span>
              <span class="letter green letter-5"></span>
              <span class="letter green letter-5"></span>
              <span class="letter letter-none"></span>
              <span class="letter green letter-M"></span>
              <span class="letter green letter-0"></span>
          ...
          <div class="destination-info">
            <div class="map-panel" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
              <div class="map">
                ...
                <iframe class="off" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2374.114749315496!2d-2.2467089841563657!3d53.48427948000816!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487bb1c6a7835f7d%3A0x245ee6918352f494!2sHarvey%20Nichols!5e0!3m2!1sen!2sua!4v1643380321185!5m2!1sen!2sua" width="auto" height="260" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
              </div>
              <!-- <a href="https://goo.gl/maps/c5jGzfdUxNBJ9xct9" target="blank" class="map-link btn primary">Open in Google Maps &nbsp <span>➞</span></a> -->
            ...
            <div class="schedule">
              ...
              <div class="address">
                ...
                <p data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
                  <strong>Harvey Nichols,</strong> <br>
      ...
      <section class="cabin" id="cabin">
        <div class="container">
          ...
          <form class="form" id="cabin-search-form" action="" name="search" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
            <div class="btn primary search">
              <button type="button"><svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30" width="30px" height="30px"><path d="M 13 3 C 7.4889971 3 3 7.4889971 3 13 C 3 18.511003 7.4889971 23 13 23 C 15.396508 23 17.597385 22.148986 19.322266 20.736328 L 25.292969 26.707031 A 1.0001 1.0001 0 1 0 26.707031 25.292969 L 20.736328 19.322266 C 22.148986 17.597385 23 15.396508 23 13 C 23 7.4889971 18.511003 3 13 3 z M 13 5 C 17.430123 5 21 8.5698774 21 13 C 21 17.430123 17.430123 21 13 21 C 8.5698774 21 5 17.430123 5 13 C 5 8.5698774 8.5698774 5 13 5 z"/></svg></button>
            ...
            <div class="swiper-wrapper">
              <div class="postcard swiper-slide" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
                ...
                <div class="card-face back">
                  <div class="content">
                    <img src="assets/images/postcard-backside.png" alt=""></div>
                  </div>
              </div>
              <div class="postcard swiper-slide" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
        ...
        <div class="frame">
          <div class="container">
            ...
            <div class="sponsors-wrap">
              <img src="assets/images/logo-bar.png" alt="" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
              <img src="assets/images/logo-bar.png" alt="" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
            </div>
            <div class="sponsors-wrap-mob">
              <img src="assets/images/logo-bar-mob.png" alt="">
              <img src="assets/images/logo-bar-mob.png" alt="">
            </div>
